...
public class TelaBatalha extends VBox {
   ...
   public BorderPane criarSceneBatalha(int numeroBatalha, List<Pokemon> pokemonsJogador){
       ...
       actionBar.getChildren().addAll(btnAtacar, btnPokemon, btnBattleInfo);
       ...
       scrollMensagem.setMaxHeight(150);
       ...
       centerBox.getChildren().addAll(infoBox, scrollMensagem, trocaPokemonBox);
           ...
           if (batalhaService.getVencedor().equals("JOGADOR")) {
               ...
               if (proximaBatalha <= 3) {
                   ...
                   pause.setOnFinished(e -> {
                       ...
                       BorderPane proximaBatalhaRoot = criarSceneBatalha(proximaBatalha, pokemonsComHpAtual);
                       javafx.scene.Scene newScene = new javafx.scene.Scene(proximaBatalhaRoot, currentWidth, currentHeight);
